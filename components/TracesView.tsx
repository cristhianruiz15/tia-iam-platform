              ...
              traces.map(trace => (
                <motion.div 
                  ...
                  className={`p-4 bg-white rounded-xl border-2 cursor-pointer transition-all ${
                    selectedTrace?.trace_id === trace.trace_id ? 'border-tia-red shadow-lg shadow-tia-red/5' : 'border-slate-200 hover:border-tia-red/30'
                  }`}
                >
                  ...
                  <div className="mt-3 flex gap-1">
                    {trace.expected_targets.map(target => (
                      <span key={target} className={`w-1.5 h-1.5 rounded-full ${
                        trace.completed_targets.includes(target) ? 'bg-emerald-500' : 
              ...
              >
                ...
                <div className="flex border-b border-slate-100 bg-slate-50/50">
                  <button 
                    ...
                    className={`px-6 py-4 text-xs font-bold uppercase tracking-wider transition-colors border-b-2 flex items-center gap-2 ${
                      activeTab === 'details' ? 'border-tia-red text-tia-red bg-white' : 'border-transparent text-slate-400 hover:text-slate-600'
                    }`}
                  >
                  ...
                  <button 
                    ...
                    className={`px-6 py-4 text-xs font-bold uppercase tracking-wider transition-colors border-b-2 flex items-center gap-2 ${
                      activeTab === 'raw' ? 'border-tia-red text-tia-red bg-white' : 'border-transparent text-slate-400 hover:text-slate-600'
                    }`}
                  >
                  ...
                  <button 
                    ...
                    className={`px-6 py-4 text-xs font-bold uppercase tracking-wider transition-colors border-b-2 flex items-center gap-2 ${
                      activeTab === 'logs' ? 'border-tia-red text-tia-red bg-white' : 'border-transparent text-slate-400 hover:text-slate-600'
                    }`}
                  >
